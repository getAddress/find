...
export declare class AddressSelectedEvent {
    static dispatch(element: HTMLElement | Document, address: AutocompleteAddress): void;
}
export declare class AddressSelectedFailedEvent {
    static dispatch(element: HTMLElement | Document, status: number, message: string): void;
}
