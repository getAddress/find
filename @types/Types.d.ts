...
export declare class AddressSelectedEvent extends Event {
    address: AutocompleteAddress | null;
}
export declare class LookupSuccessEvent extends Event {
    suggestions: Suggestion[];
}
export declare class LookupFailedEvent extends Event {
    status: number;
    message: string | null;
}
